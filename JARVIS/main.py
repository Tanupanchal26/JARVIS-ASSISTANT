...
class JarvisLive:
    def __init__(self, ui: JarvisUI):
        ...
        self._enhanced_live = False  # v1beta is available to standard API projects
    ...
    async def run(self):
        ...
        while True:
            try:
                ...
                # Invalid API key or OAuth token — stop hammering the API and
                # prompt re-configuration instead of reconnecting forever.
                err_lower = err_str.lower()
                if "project has been denied access" in err_lower:
                    message = (
                        "ERR: Google denied this project's Gemini API access. "
                        "Check billing/API access in Google AI Studio or contact Google support."
                    )
                ...
                if (
                    ...
                    or "invalid authentication credentials" in err_lower
                    or "1007" in err_str
                ):
